...
namespace Com.DanLiris.Service.Purchasing.WebApi.Controllers.v1.UnitPaymentOrderControllers
{
    ...
    public class UnitPaymentOrderController : Controller
    {
        ...
        public IActionResult GetReportAll(string unitId, string supplierId,string noSPB, DateTime? dateFrom, DateTime? dateTo, DateTime? inputDate, string divisionId, int page, int size, string Order = "{}")
        {
            ...
            try
            {
                ...
                var data = facade.GetReportAll(unitId, supplierId, noSPB, dateFrom, dateTo, inputDate,divisionId, page, size, Order, offset);
        ...
        public IActionResult GetXlsAll(string unitId, string supplierId,string noSPB, DateTime? dateFrom, DateTime? dateTo, DateTime? inputDate, string divisionId)
        {
            ...
            try
            {
                ...
                var xls = facade.GenerateExcel(unitId, supplierId, noSPB, dateFrom, dateTo, inputDate, divisionId, offset);
