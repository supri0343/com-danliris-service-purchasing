...
namespace Com.DanLiris.Service.Purchasing.Test.Facades.ReportTest
{
    ...
    public class LocalPurchasingBookReportTest
    {
        ...
        public async Task Should_Success_GetReport_FalseIsValas()
        {
            ...
            var result = await facade.GetReportDataV2(urn.URNNo, Convert.ToInt32(urn.UnitId), Convert.ToInt32(pr.CategoryId), DateTime.Now.AddDays(-7), DateTime.Now.AddDays(7), It.IsAny<DateTime>(), It.IsAny<DateTime>(), false, It.IsAny<int>());
        ...
        public async Task Should_Success_GetReport_TrueIsValas()
        {
            ...
            var result = await facade.GetReportDataV2(urn.URNNo, Convert.ToInt32(urn.UnitId), Convert.ToInt32(pr.CategoryId), DateTime.Now.AddDays(-7), DateTime.Now.AddDays(7), It.IsAny<DateTime>(), It.IsAny<DateTime>(), true, It.IsAny<int>());
            Assert.NotNull(result);
        ...
        public async Task Should_Success_GetReport_XLS()
        {
            ...
            //Assert.NotNull(result);
            var resultExcel = await facade.GenerateExcel(urn.URNNo, Convert.ToInt32(urn.UnitId), Convert.ToInt32(pr.CategoryId), DateTime.Now.AddDays(-7), DateTime.Now.AddDays(7), It.IsAny<DateTime>(), It.IsAny<DateTime>(), false, It.IsAny<int>());
        ...
        public async Task Should_Success_Get_Data()
        {
            ...
            var result = await facade.GetReportV2(urn.URNNo, Convert.ToInt32(urn.UnitId), Convert.ToInt32(pr.CategoryId), DateTime.Now.AddDays(-7), DateTime.Now.AddDays(7), It.IsAny<DateTime>(), It.IsAny<DateTime>(), true, It.IsAny<int>());
            Assert.NotNull(result);

            result = await facade.GetReportV2(urn.URNNo, Convert.ToInt32(urn.UnitId), Convert.ToInt32(pr.CategoryId), DateTime.Now.AddDays(-7), DateTime.Now.AddDays(7), It.IsAny<DateTime>(), It.IsAny<DateTime>(), true, It.IsAny<int>());
            Assert.NotNull(result);
        }
