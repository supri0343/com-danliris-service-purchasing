...
namespace Com.DanLiris.Service.Purchasing.Test.Controllers.Report
{
    public class ImportPurchasingBookReportTest
    {
        ...
        public async Task Should_Success_GetLocalPurchasingBookReport()
        {
            ...
            mockFacade.Setup(facade => facade.GetReportV2(It.IsAny<string>(), It.IsAny<int>(), It.IsAny<int>(), It.IsAny<DateTime>(), It.IsAny<DateTime>(), It.IsAny<DateTime>(), It.IsAny<int>())).ReturnsAsync(new LocalPurchasingBookReportViewModel());

            var controller = new ImportPurchasingBookReportController(mockFacade.Object);
            var response = await controller.Get(It.IsAny<string>(), It.IsAny<int>(), It.IsAny<int>(), It.IsAny<DateTime>(), It.IsAny<DateTime>(), It.IsAny<DateTime>(), It.IsAny<int>());
        ...
        {
            var mockFacade = new Mock<IImportPurchasingBookReportFacade>();
            mockFacade.Setup(facade => facade.GetReportV2(It.IsAny<string>(), It.IsAny<int>(), It.IsAny<int>(), It.IsAny<DateTime>(), It.IsAny<DateTime>(), It.IsAny<DateTime>(), It.IsAny<int>())).ThrowsAsync(new Exception());
        ...
        {
            var mockFacade = new Mock<IImportPurchasingBookReportFacade>();
            mockFacade.Setup(facade => facade.GenerateExcel(It.IsAny<string>(), It.IsAny<int>(), It.IsAny<int>(), It.IsAny<DateTime>(), It.IsAny<DateTime>(), It.IsAny<DateTime>(), It.IsAny<int>())).ReturnsAsync(new MemoryStream());
        ...
        {
            var mockFacade = new Mock<IImportPurchasingBookReportFacade>();
            mockFacade.Setup(facade => facade.GenerateExcel(It.IsAny<string>(), It.IsAny<int>(), It.IsAny<int>(), It.IsAny<DateTime>(), It.IsAny<DateTime>(), It.IsAny<DateTime>(), It.IsAny<int>())).ThrowsAsync(new Exception());
        ...
        public async Task Should_Success_GetXls()
        {
            ...
            //Act
            var controller = new ImportPurchasingBookReportController(mockFacade.Object);
            var response = await controller.GetXls(It.IsAny<string>(), It.IsAny<int>(), It.IsAny<int>(), It.IsAny<DateTime>(), It.IsAny<DateTime>(), It.IsAny<DateTime>(), It.IsAny<int>());
        ...
        public async Task Should_Throws_InternalServerError_GetXls()
        {
            //Setup
            var mockFacade = new Mock<IImportPurchasingBookReportFacade>();
            mockFacade.Setup(facade => facade.GenerateExcel(It.IsAny<string>(), It.IsAny<int>(), It.IsAny<int>(), It.IsAny<DateTime?>(), It.IsAny<DateTime?>(), It.IsAny<DateTime>(), It.IsAny<int>())).Throws(new Exception());
        ...
        public async Task Should_Success_GetImportPurchasingBookReport_Pdf()
        {
            ...
            var response = await controller.GetPdf(It.IsAny<string>(), It.IsAny<int>(), It.IsAny<int>(), It.IsAny<DateTime>(), It.IsAny<DateTime>(), It.IsAny<DateTime>(), It.IsAny<int>());
