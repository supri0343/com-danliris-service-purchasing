...
namespace Com.DanLiris.Service.Purchasing.Test.DataUtils.GarmentUnitExpenditureDataUtils
{
    public class GarmentUnitExpenditureNoteDataUtil
    {
        ...
        public async Task<GarmentUnitExpenditureNote> GetNewData4(GarmentUnitDeliveryOrder garmentunitdeliveryorder = null)
        {
            long nowTicks = DateTimeOffset.Now.Ticks;
        ...
        public async Task<GarmentUnitExpenditureNote> GetTestData4()
        {
