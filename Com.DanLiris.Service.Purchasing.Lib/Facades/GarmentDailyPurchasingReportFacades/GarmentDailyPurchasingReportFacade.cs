...
namespace Com.DanLiris.Service.Purchasing.Lib.Facades.GarmentDailyPurchasingReportFacade
{
    public class GarmentDailyPurchasingReportFacade : IGarmentDailyPurchasingReportFacade
    {
        ...
        public IEnumerable<GarmentDailyPurchasingReportViewModel> GetGarmentDailyPurchasingReportQuery(string unitName, bool supplierType, string supplierName, DateTime? dateFrom, DateTime? dateTo, DateTime? inputDateFrom, DateTime? inputDateTo, string jnsbc, int offset)
        {
            ...
            List < GarmentDailyPurchasingTempViewModel > d1 = (from a in dbContext.GarmentDeliveryOrders
            ...
            List<GarmentDailyPurchasingTempViewModel> d2 = (from gc in dbContext.GarmentCorrectionNotes
            ...
            List<GarmentDailyPurchasingTempViewModel> d3 = (from gc in dbContext.GarmentCorrectionNotes
                                                                 join gci in dbContext.GarmentCorrectionNoteItems on gc.Id equals gci.GCorrectionId
                                                                 join ipo in dbContext.GarmentInternalPurchaseOrders on gci.POId equals ipo.Id
                                                                 join gdd in dbContext.GarmentDeliveryOrderDetails on gci.DODetailId equals gdd.Id
                                                                 join gdi in dbContext.GarmentDeliveryOrderItems on gdd.GarmentDOItemId equals gdi.Id
            ...
            List<GarmentDailyPurchasingTempViewModel> d4 = (from gc in dbContext.GarmentCorrectionNotes
                                                                 join gci in dbContext.GarmentCorrectionNoteItems on gc.Id equals gci.GCorrectionId
                                                                 join ipo in dbContext.GarmentInternalPurchaseOrders on gci.POId equals ipo.Id
                                                                 join gdd in dbContext.GarmentDeliveryOrderDetails on gci.DODetailId equals gdd.Id
                                                                 join gdi in dbContext.GarmentDeliveryOrderItems on gdd.GarmentDOItemId equals gdi.Id
            ...
            List<GarmentDailyPurchasingTempViewModel> d5 = (from inv in dbContext.GarmentInvoices
            ...
            List<GarmentDailyPurchasingTempViewModel> d6 = (from inv in dbContext.GarmentInvoices
                                                                 join invi in dbContext.GarmentInvoiceItems on inv.Id equals invi.InvoiceId
                                                                 join invd in dbContext.GarmentInvoiceDetails on invi.Id equals invd.InvoiceItemId
                                                                 join gdd in dbContext.GarmentDeliveryOrderDetails on invd.DODetailId equals gdd.Id
                                                                 join gdi in dbContext.GarmentDeliveryOrderItems on gdd.GarmentDOItemId equals gdi.Id
