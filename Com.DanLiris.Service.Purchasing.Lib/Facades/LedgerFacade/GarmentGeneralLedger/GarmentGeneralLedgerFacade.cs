...
namespace Com.DanLiris.Service.Purchasing.Lib.Facades.LedgerFacade.GarmentGeneralLedger
{
    public class GarmentGeneralLedgerFacade : IGarmentGeneralLedgerFacade
    {
        private readonly PurchasingDbContext _dbContext;
        private readonly IdentityService _identityService;
        private const string UserAgent = "Facade";

        public GarmentGeneralLedgerFacade(PurchasingDbContext dbContext, IdentityService identityService)
        {
