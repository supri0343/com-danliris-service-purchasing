...
namespace Com.DanLiris.Service.Purchasing.Lib.Interfaces
{
    public interface IGarmentInternNoteFacade
    {
        ...
        Task<int> CreateWithInvoice(GarmentInternNote m, bool isImport, string user, int clientTimeZoneOffset = 7);
        ...
        List<GarmentInternalNoteDto> BankExpenditureReadInternalNotes(string currencyCode, int supplierId, int niId);
