...
namespace Com.DanLiris.Service.Purchasing.Lib.Interfaces
{
    public interface IUnitPaymentOrderFacade
    {
        ...
        Tuple<List<ViewModels.UnitPaymentOrderViewModel.UnitPaymentOrderReportViewModel>, int> GetReportAll(string unitId, string supplierId,string noSPB, DateTime? dateFrom, DateTime? dateTo, DateTime? inputDate, string divisionId, int page, int size, string Order, int offset);
        MemoryStream GenerateExcel(string unitId, string supplierId,string noSPB, DateTime? dateFrom, DateTime? dateTo, DateTime? inputDate, string divisionId, int offset);
