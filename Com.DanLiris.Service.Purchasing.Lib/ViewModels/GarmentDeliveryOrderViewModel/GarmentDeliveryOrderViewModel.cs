    ...
    public class GarmentDeliveryOrderViewModel : BaseViewModel, IValidatableObject
	{
        ...
        public IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            else
            {
                ...
                if (purchasingDbContext.GarmentDeliveryOrders.AsNoTracking().ToList().Where(DO => DO.DONo == (doNo) && DO.Id != Id && DO.DODate.ToOffset((new TimeSpan(7, 0, 0))) == doDate && DO.SupplierId == supplier.Id && DO.ArrivalDate.ToOffset((new TimeSpan(7, 0, 0))) == arrivalDate).Count() > 0)
                {
