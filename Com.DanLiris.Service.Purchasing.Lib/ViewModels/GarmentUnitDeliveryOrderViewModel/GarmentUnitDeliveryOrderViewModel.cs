                ...
                else
                {
                    ...
                    foreach (var item in Items)
                    {
                        ...
                        if (item.IsSave)
                        {
                            ...
                            if (Storage.name == "GUDANG BAHAN BAKU" && UnitDOType != "SAMPLE" && (string.IsNullOrWhiteSpace(item.Colour) || string.IsNullOrWhiteSpace(item.Rack) || string.IsNullOrWhiteSpace(item.Box) || string.IsNullOrWhiteSpace(item.Level)))
                            {
                                itemErrorCount++;
